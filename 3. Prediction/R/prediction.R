# Connect to our data
myPredictionData <- read.csv("C:/Users/merve/Desktop/Ex_Files_Data_Science_of_Marketing/Exercise_Files/04_02/prediction-r.csv")

# Data Description
## A: highest performance, B: middle, C: low
